...
<div class="posts-wrap" id="page">
	<h2 class="post_title">Support Margaret Campaign</h2>
		<form method="post" action="http://themes.designcrumbs.com/html/campaign/page-contact.php" id="cForm" class="form"> 		<p>
			<label>Name*</label>
			<input name="cName" type="text" id="cName" size="35" value="" />
		</p>
		<p>
			<label>Phone</label>
			<input name="cPhone" type="text" id="cPhone" size="35" value="" />
		</p>
		<p>
			<label>Email*</label>
		...
		<p>
			<label>Message</label>
			<textarea name="cMessage" cols="30" rows="5" id="cMessage"></textarea>
		</p>
		<p>
